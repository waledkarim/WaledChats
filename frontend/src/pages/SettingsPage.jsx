...
const SettingsPage = () => {
  ...
  function handleThemeClick(btnIndex){
            ...
            <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-2">

              {
                THEMES.map((t) => (
                    ...
                    <button
                      key={t}
                      className={`group flex flex-col items-center gap-1.5 p-2 rounded-lg transition-colors ${theme === t ? "bg-base-200" : "hover:bg-base-200/50"}`} onClick={() => handleThemeClick(t)}>
                          ...
                          <div className="px-4 py-3 border-b border-base-300 bg-base-100">
                              ...
                              <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                    ...
                                    <h3 className="font-medium text-sm">Waled Karim</h3>
